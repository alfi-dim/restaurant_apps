...
document.addEventListener('DOMContentLoaded', () => {
    ...
    buttonViewElement.forEach((btn) => {
        btn.addEventListener('click', e => {
            viewSetting = e.target.getAttribute('data-show');
    ...
    document.addEventListener(RENDER_EVENT, () => {
        ...
        // const buttonElement = document.querySelectorAll('.readmore')
        // buttonElement.forEach((e) => {
        //     const idButtonTarget = e.getElementById(`[id^="read-"]`);
        //     idButtonTarget.addEventListener('click', () => {
            
        //     const fullDescElement = e.getElementById(`full-${data.id}`);
        //     const dotsElement = e.getElementById(`dots-${data.id}`);
        //     if (fullDescElement.style.display === 'none') {
        //         const allFullDescElement = document.querySelectorAll(`[id^="full-"]`);
        //         const allDotsElement = document.querySelectorAll(`[id^="dots-"]`);
        //         allFullDescElement.forEach((e) => {
