...
describe('Liking A Restaurant', () => {
  ...
  it('shoud show the like button when movie has not been liked before', async () => {
  ...
  it('shoud not show the unlike button when movie has not been liked before', async () => {
    await TestFactories.checkIsRestaurantFavorited({ id: 1 });
